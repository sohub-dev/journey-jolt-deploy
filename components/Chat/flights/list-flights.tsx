...
export function ListFlights({
  ...
  return (
    <div className="max-h-[500px] overflow-y-auto w-fit pr-4">
      <div className="rounded-lg bg-jjBlack/[0.04] dark:bg-white/[0.04] px-4 py-1.5 flex flex-col min-w-fit w-fit">
        {results.flights.map((flight) => (
          ...
          >
            ...
            <div className="flex flex-col w-32 items-end justify-between gap-4">
              <div className="flex flex-col items-end gap-0">
                <div className="text-base sm:text-base text-emerald-600 dark:text-emerald-500">
                  {flight.priceInEuros}€
                </div>
                <span className="text-xs sm:text-sm text-black/60 dark:text-white/60 text-right whitespace-nowrap">
                  For all passengers
                </span>
              </div>
              <div className="text-xs sm:text-sm text-muted-foreground flex flex-row whitespace-nowrap">
                {results.type === "inbound" ? "Inbound" : "Outbound"}
              </div>
            </div>
          </div>
        ))}
