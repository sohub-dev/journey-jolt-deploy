    ...
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      <PopoverTrigger asChild>
        {renderTrigger ? (
          ...
          <div
            className={cn(
              "flex w-full cursor-pointer items-center h-9 ps-3 pe-1 font-normal border border-black/5 dark:border-white/5 rounded-md text-sm shadow-sm",
      ...
      <PopoverContent className="w-auto p-2 bg-white dark:bg-jjBlack">
        ...
        <div className="relative overflow-hidden">
          ...
          <MonthYearPicker
            ...
            maxDate={maxDate}
            className={cn(
              "absolute top-0 left-0 bottom-0 right-0 bg-white dark:bg-jjBlack",
